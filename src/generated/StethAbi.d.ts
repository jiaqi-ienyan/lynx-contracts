...
export class StethAbi extends BaseContract {
  ...
  filters: {
    ...
    "StakingResumed()"(): TypedEventFilter<[], {}>;
    ...
    "StakingLimitSet(uint256,uint256)"(
      ...
      [BigNumber, BigNumber],
      { maxStakeLimit: BigNumber; stakeLimitIncreasePerBlock: BigNumber }
    >;
    ...
    "StakingLimitRemoved()"(): TypedEventFilter<[], {}>;
    ...
    ): TypedEventFilter<[BigNumber], { depositedValidators: BigNumber }>;
    ...
    "LidoLocatorSet(address)"(
      lidoLocator?: null
    ): TypedEventFilter<[string], { lidoLocator: string }>;
    ...
    "EIP712StETHInitialized(address)"(
      eip712StETH?: null
    ): TypedEventFilter<[string], { eip712StETH: string }>;
    ...
    "TransferShares(address,address,uint256)"(
      ...
      [string, string, BigNumber],
      { from: string; to: string; sharesValue: BigNumber }
    >;
